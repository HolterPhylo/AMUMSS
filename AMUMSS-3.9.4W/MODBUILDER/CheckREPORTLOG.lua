...
if BugCount > 0 then
  if BugCount > 1 then
    say1 = string.format(say..[[%6u BUGs reported. PLEASE post ALL scripts AND "REPORT.txt" on Discord:  https://discord.gg/8jGtEcDPEY]],BugCount)
  else
    say1 = string.format(say..[[%6u BUG reported. PLEASE post ALL scripts AND "REPORT.txt" on Discord:  https://discord.gg/8jGtEcDPEY]],BugCount)
  end
  print("")
  print(say1)
  print(say2)
