...
THREE CASES:
    ...
    C) you have AMUMSS 3.9.5W or later ==> execute BUILDMOD.bat to update (nothing more to do)

DOWNLOAD COMPLETE VERSION
    * COMPLETE VERSION available as a zip release at:
        https://github.com/HolterPhylo/AMUMSS/releases/tag/v3.9.5W (or Latest release)
      or
        https://github.com/MetaIdea/AMUMSS-nms-auto-modbuilder-updater-modscript-system/releases/tag/AMUMSS-3.9.5W (or Latest release)
